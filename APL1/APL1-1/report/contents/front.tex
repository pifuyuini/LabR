...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		\hline
		Grade \& Major： & 2022, Physics &Group number： & Group 2\\
		\hline
...
% 大标题
\begin{center}
	\huge \textbf{APL1-1 \quad 锁相放大器工作原理、基本参数与基本操作\\Working Principle, Basic Parameters and Operation of Lock-in Amplifier}
\end{center}
...
\textbf{【Safety】}	
\begin{enumerate}
	\item The OE1022 lock-in amplifier input cannot be connected to a strong signal; the input signal must be limited to below 1V.
	\item The current output of the OE4201 voltage-controlled current source cannot be directly connected to the input of the OE1022 lock-in amplifier.
\end{enumerate}	
...
Special thanks to \textbf{Huanyu Shi}, a senior from the Class of 2019, for providing the \LaTeX \ \textbf{original} template for this experiment report. 
...
Additionally, \textcolor{fred}{\textbf{this experiment report is being improved towards full English expression, so there may be instances of mixed Chinese and English during this transition period. We appreciate your understanding!}}
